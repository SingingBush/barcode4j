...
public class EscapeHandler {
     ...
     * 
     */
    public static char decodeChar(String msg, int start, int end, int base) {
            	...
            	switch (c) {
					...
					case 'c': 
					    if (i>=len || (c=msg.charAt(i++)) != 'd') 
					        ...
					        ret.append(EAN128Bean.defaultCheckDigitMarker); 
						break;
					...
					case 'g': 
					    if (i>=len || (c=msg.charAt(i++)) != 's') 
					        ...
					        ret.append(EAN128Bean.defaultGroupSeparator); 
						break;
					case 'n': ret.append('\n'); break;
