...
/**
 * Logic Handler to be used by Australia Post barcodes 
 * for painting on a Canvas.
 * Couldn't use the FourStateLogicHandler, as the bar values are reversed
 * for Australia Post
 * 
 * @author Antun Oreskovic
 * @version $Id: FourStateAustPostLogicHandler.java 2008/12/30 $
 */
public class FourStateAustPostLogicHandler 
     ...
     */
    public FourStateAustPostLogicHandler(HeightVariableBarcodeBean bcBean, Canvas canvas) {
        super(bcBean, canvas);
    }
